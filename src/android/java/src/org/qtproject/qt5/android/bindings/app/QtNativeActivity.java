...
import org.qtproject.qt5.android.bindings.view.QtUniMenu;

public class QtUniActivity extends org.qtproject.qt5.android.bindings.QtActivity
{
    public QtUniActivity() {
        m_menu = null;
    }

    public void setOptionsMenu(QtUniMenu menu) {
        if (m_menu != menu) {
            m_menu = menu;
