...
#ifndef QUNICONTROLSPLATFORMPLUGIN_H
#define QUNICONTROLSPLATFORMPLUGIN_H

#include <QtCore/QtPlugin>

QT_BEGIN_NAMESPACE

#define Q_UNI_FORWARD_DECLARE(TYPE) class QUni ## TYPE; class QUniPlatform ## TYPE;

Q_UNI_FORWARD_DECLARE(Window)
Q_UNI_FORWARD_DECLARE(View)
Q_UNI_FORWARD_DECLARE(Control)
Q_UNI_FORWARD_DECLARE(Button)
Q_UNI_FORWARD_DECLARE(TextField)
Q_UNI_FORWARD_DECLARE(SearchField)
Q_UNI_FORWARD_DECLARE(Page)
Q_UNI_FORWARD_DECLARE(TabsPage)
Q_UNI_FORWARD_DECLARE(TabsPageTab)
...
#endif // QUNICONTROLSPLATFORMPLUGIN_H
