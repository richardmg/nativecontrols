...
public:
    explicit QUniButton(QUniBase *parent = nullptr);
...
protected:
    QUniButton(QUniButtonPrivate &dd, QUniBase *parent = nullptr);

private:
    Q_DECLARE_PRIVATE(QUniButton)
    Q_DISABLE_COPY(QUniButton)
};
