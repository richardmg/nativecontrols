...
class QmlUniControlsPlugin: public QQmlExtensionPlugin
{
    Q_OBJECT
...
QmlUniControlsPlugin(QObject *parent = nullptr) : QQmlExtensionPlugin(parent)
{
}
...
#include "qmlunicontrolsplugin.moc"
