...
#ifndef QNATIVEPLATFORMCONTROL_H
#define QNATIVEPLATFORMCONTROL_H
...
class Q_NATIVECONTROLS_EXPORT QNativePlatformControl : public virtual QNativePlatformBase
{
public:
...
#endif // QNATIVEPLATFORMCONTROL_H
