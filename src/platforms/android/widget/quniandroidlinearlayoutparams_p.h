...
public:
    explicit QUniAndroidLinearLayoutParams(QUniAndroidView *view);
...
private:
    Q_DISABLE_COPY(QUniAndroidLinearLayoutParams)
    Q_DECLARE_PRIVATE(QUniAndroidLinearLayoutParams)
};
