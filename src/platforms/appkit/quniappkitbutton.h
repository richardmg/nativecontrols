...
#ifndef QUNIAPPKITBUTTON_H
#define QUNIAPPKITBUTTON_H
...
class Q_UNIAPPKITCONTROLS_EXPORT QUniAppKitButton : public QUniAppKitControl, public virtual QUniPlatformButton
{
    Q_OBJECT
