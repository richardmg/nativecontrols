...
#ifndef QUNIAPPKITSEARCHFIELD_H
#define QUNIAPPKITSEARCHFIELD_H
...
class Q_UNIAPPKITCONTROLS_EXPORT QUniAppKitSearchField : public QUniAppKitControl, public virtual QUniPlatformSearchField
{
    Q_OBJECT
